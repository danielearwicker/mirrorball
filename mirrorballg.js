...
var copyFile = wrapGenerator.mark(function copyFile(fromPath, toPath) {
    ...
    return wrapGenerator(function copyFile$(context$1$0) {
        ...
        case 24:
            ...
            return ay(h).forEach(wrapGenerator.mark(function callee$1$0(handle) {
                return wrapGenerator(function callee$1$0$(context$2$0) {
                    while (1) switch (context$2$0.prev = context$2$0.next) {
                    case 0:
                        context$2$0.next = 2;
...
var mirror = wrapGenerator.mark(function mirror(folderPaths) {
    ...
    return wrapGenerator(function mirror$(context$1$0) {
        ...
        case 2:
            ...
            extras = [];
            context$1$0.t22 = wrapGenerator.keys(states[0]);
        case 5:
...
var ay = (function() {
    ...
    var prototype = {
        map: function(gen, thisArg ) {
            var self = this;
            return ay(wrapGenerator.mark(function callee$2$0() {
                var ar, len, result, i;
