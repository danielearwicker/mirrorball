...
var removeEmptyFolders = regeneratorRuntime.mark(function removeEmptyFolders(folder) {
    return regeneratorRuntime.wrap(function removeEmptyFolders$(context$1$0) {
        ...
        case 8:
            return context$1$0.delegateYield(removeEmptyFolders(path.dirname(folder)), "t2", 9);
        case 9:
            context$1$0.next = 13;
            break;
        case 11:
...
var renameFile = regeneratorRuntime.mark(function renameFile(oldName, newName) {
    return regeneratorRuntime.wrap(function renameFile$(context$1$0) {
        ...
        case 3:
            return context$1$0.delegateYield(removeEmptyFolders(path.dirname(oldName)), "t5", 4);
        case 4:
        case "end":
            return context$1$0.stop();
        }
...
var scanFolder = regeneratorRuntime.mark(function scanFolder(p, each) {
    ...
    return regeneratorRuntime.wrap(function scanFolder$(context$1$0) {
        ...
        case 9:
            ...
            return context$1$0.delegateYield(scanFolder(path.join(p, child), each), "t6", 13);
        case 13:
            n++;
            context$1$0.next = 9;
            break;
        case 16:
            ...
            break;
        case 18:
            return context$1$0.delegateYield(each(p, s), "t7", 19);
        case 19:
            context$1$0.next = 24;
            break;
        case 21:
...
var fetchState = regeneratorRuntime.mark(function fetchState(folderPath) {
    ...
    return regeneratorRuntime.wrap(function fetchState$(context$1$0) {
        ...
        case 5:
            ...
            state = JSON.parse(context$1$0.t10);
            context$1$0.next = 11;
            break;
        case 9:
            context$1$0.prev = 9;
                ...
                scanFolder(folderPath, regeneratorRuntime.mark(function callee$1$0(filePath, fileStat) {
                    ...
                    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
                        ...
                        case 0:
                            ...
                            return context$2$0.delegateYield(hash(filePath, fileStat), "t9", 4);
                        case 4:
                            fileHash = context$2$0.t9;
...
var copyFile = regeneratorRuntime.mark(function copyFile(fromPath, toPath) {
    ...
    return regeneratorRuntime.wrap(function copyFile$(context$1$0) {
        ...
        case 0:
            ...
            return context$1$0.delegateYield(makePathTo(toPath), "t13", 2);
        case 2:
            context$1$0.next = 4;
...
var pickOne = regeneratorRuntime.mark(function pickOne(prompt, options) {
    ...
    return regeneratorRuntime.wrap(function pickOne$(context$1$0) {
        ...
        case 4:
            ...
            context$1$0.t15 = parseInt(context$1$0.t14, 10);
            context$1$0.t16 = context$1$0.t15 - 1;
            o = options[context$1$0.t16];
...
var mirror = regeneratorRuntime.mark(function mirror(folderPaths) {
    ...
    return regeneratorRuntime.wrap(function mirror$(context$1$0) {
        ...
        case 15:
            choice = context$1$0.t21;
            return context$1$0.delegateYield(choice(), "t22", 17);
        case 17:
            context$1$0.next = 5;
            break;
        case 19:
        ...
        case 50:
            ...
            return context$1$0.delegateYield(deleteFile(extra.from + extra.path), "t24", 54);
        case 54:
            context$1$0.next = 57;
            break;
        case 56:
            return context$1$0.delegateYield(copyFile(extra.from + extra.path, extra.to + extra.path), "t25", 57);
        case 57:
            c++;
            context$1$0.next = 50;
            break;
